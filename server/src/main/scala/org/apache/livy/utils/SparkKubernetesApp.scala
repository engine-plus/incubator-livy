...
class SparkKubernetesApp private[utils](appTag: String,
                                        ...
                                        // For unit test.
                                        kubernetesClient: =>
                                        KubernetesClient = SparkKubernetesApp.kubernetesClient)
  extends SparkApp
    with Logging {
...
object KubernetesExtensions {
  ...
  implicit class KubernetesClientExtensions(client: KubernetesClient) {
    ...
    private def buildSparkUIIngress(app: KubernetesApplication,
                                    protocol: String,
                                    host: String,
                                    service: Service,
